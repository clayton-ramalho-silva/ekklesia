<div class="menu-site">
    ...
    <nav>
        <a href="{{ route('dashboard') }}"{!! request()->is('dashboard/*') || request()->is('dashboard') ? ' class="ativo"' : '' !!}>
        ...
        <a href="{{ route('membros.index') }}"{!! Request::is('membros','membros/*') ? ' class="ativo"' : '' !!}>

            <svg viewBox="0 0 24 24" width="24" height="24" stroke="#183550"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle><path d="M23 21v-2a4 4 0 0 0-3-3.87"></path><path d="M16 3.13a4 4 0 0 1 0 7.75"></path></svg>

            <span>Membros</span>
        </a>

        <a href="{{ route('ministerios.index') }}"{!! Request::is('ministerios','ministerios/*') ? ' class="ativo"' : '' !!}>
        ...
        <a href="{{ route('jobs.index') }}"{!! Request::is('jobs','jobs/*') ? ' class="ativo"' : '' !!}>
        ...
        <a href="{{ route('resumes.index') }}"{!! Request::is('resumes','resumes/*') ? ' class="ativo"' : '' !!}>
        ...
        <a href="{{ route('interviews.index') }}"{!! Request::is('interviews','interviews/*') ? ' class="ativo"' : '' !!}>
        ...
        @if (Auth::user()->role == 'admin')
            <a href="{{ route('users.index') }}"{!! Request::is('register','users','users/*') ? ' class="ativo"' : '' !!}>
        ...
        <a href="{{ route('logs.index') }}"{!! Request::is('logs','logs/*') ? ' class="ativo"' : '' !!}>
