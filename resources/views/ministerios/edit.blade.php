...
<section class="sessao">
    ...
    <article class="f1 container-form-create">      
        <div class="container">
            ...
            <h4 class="fw-normal mb-4">Cadastro do Ministério</h4>

            <form class="form-padrao" id="form-ministerio-create" action="{{ route('ministerios.update', $ministerio->id) }}" method="post" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="row">
                    ...
                    <div class="col-9 py-0 pe-5 form-l">
                        ...
                        <div class="row">
                            ...
                            <div class="col-6 form-campo">
                                <div class="mb-3">
                                    <input type="text" placeholder="Nome do Ministério" class="floatlabel form-control" id="nome" name="nome" value="{{ old('nome', $ministerio->nome )}}">
                                ...
                                <div class="mb-3">
                                    <div class="floatlabel-wrapper ">
                                        ...
                                        <select name="departamento" id="departamento" class="form-select active-floatlabel" >
                                            <option></option>
                                            <option value="Administrativo" {{ old('departamento', $ministerio->departamento ) == 'Administrativo' ? 'selected' : ''}}> Administrativo</option>
                                            <option value="Eclesiástico" {{ old('departamento', $ministerio->departamento) == 'Eclesiástico' ? 'selected' : ''}}> Eclesiástico</option>
                                            <option value="Outro" {{ old('departamento', $ministerio->departamento) == 'Outro' ? 'selected' : ''}}> Outro</option>                                            
                                        </select>
                            ...
                            <div class="col-12 form-campo">
                                <div class="mb-3">
                                    <div class="floatlabel-wrapper">
                                        <label for="lideres" class="label-floatlabel form-label floatlabel-label">Líderes</label>
                                        <select name="lideres[]" id="lideres" class="form-select active-floatlabel" multiple>
                                            @foreach ($membros as $membro)
                                                <option 
                                                    value="{{ $membro->id }}" 
                                                    {{ 
                                                        (in_array($membro->id, old('lideres', $ministerio->lideresAtivos->pluck('id')->toArray())) 
                                                            ? 'selected' 
                                                            : '') 
                                                    }}
                                                >
                            ...
                            <div class="col-12 form-campo participantes">
                                <div class="mb-3">
                                    <div class="floatlabel-wrapper">
                                        <label for="participantes" class="label-floatlabel form-label floatlabel-label">Participantes</label>
                                        <select name="participantes[]" id="participantes" class="form-select active-floatlabel" multiple>
                                            @foreach ($membros as $membro)
                                                <option 
                                                    value="{{ $membro->id }}" 
                                                    {{ 
                                                        (in_array($membro->id, old('participantes', $ministerio->todos_membros->pluck('id')->toArray())) 
                                                            ? 'selected' 
                                                            : '') 
                                                    }}
                                                >
                            ...
                            <div class="col-12 form-campo">
                                <div class="mb-3">
                                    <textarea id="descricao" name="descricao" class="form-control">{{ old('descricao', $ministerio->descricao )}} </textarea>
                    ...
                    <div class="col-3 py-0 pe-5 form-l">
                        <!-- Lideres -->
                    ...
                    <div class="col-9 bloco-submit d-flex mt-3">
                        ...
                        <a href="{{ route('ministerios.index')}}" class="btn-padrao btn-cancelar ms-3">Cancelar</a>
                    </div>
