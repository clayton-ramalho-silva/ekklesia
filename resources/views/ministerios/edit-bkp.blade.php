...
<section class="cabecario">
    <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active" aria-current="page">Editar Membro: {{ $membro->nome }} </li>          
        </ol>
      </nav>
                ...
                <div class="col-12 py-0 pe-5 form-1">
                    <div class="row">
                        <div class="col-12 d-flex justify-content-between mb-4">
                            <h4 class="fw-normal">Cadastro de Membro</h4>

                            
                            <p class="fw-bold">Data do cadastro: {{$membro->created_at->format('d/m/Y') }}</p>
                        </div>
