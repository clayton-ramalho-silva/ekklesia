...
<section class="sessao">
    ...
    <article class="f1 container-form-create">      
        <div class="container">
            ...
            <form class="form-padrao" id="form-membros-create" action="{{ route('membros.update', $membro->id) }}" method="post" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="row">
                    ...
                    <div class="col-9 py-0 pe-5 form-l">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 form-campo">
                                <div class="mb-3">
                                    <input type="text" placeholder="Nome Completo" class="floatlabel form-control" id="nome" name="nome" value="{{ old('nome', $membro->nome) }}" >
                            ...
                            <div class="col-6 form-campo">
                                <div class="mb-3">
                                    <input type="text" placeholder="CPF" class="floatlabel form-control" id="cpf" name="cpf" value="{{ old('cpf', $membro->cpf)}}" placeholder="CPF">
                            ...
                            <div class="col-6 form-campo">
                                <div class="mb-3">
                                    <input type="text" placeholder="RG" class="floatlabel form-control" id="rg" name="rg" placeholder="RG" value="{{ old('rg', $membro->rg)}}" >
                            ...
                            <div class="col-6 form-campo">
                                <div class="mb-3">
                                    <div class="floatlabel-wrapper ">
                                        ...
                                        <input type="date" class="form-control active-floatlabel" id="data_nascimento" name="data_nascimento" value="{{ old('data_nascimento', $membro->data_nascimento)}}" >
                                ...
                                <div class="mb-3">
                                    <div class="floatlabel-wrapper ">
                                        ...
                                        <select name="estado_civil" id="estado_civil" class="form-select active-floatlabel" >
                                            ...
                                            <option value="Divorciado" {{ old('estado_civil', $membro->estado_civil ) == 'Divorciado' ? 'selected' : ''}}> Divorciado</option>
                                            <option value="Viúvo" {{ old('estado_civil', $membro->estado_civil ) == 'Viúvo' ? 'selected' : ''}}> Viúvo</option>                                            
                                        </select>
                            ...
                            <div class="col-4 form-campo">
                                <div class="mb-3">
                                    <div class="floatlabel-wrapper ">
                                        ...
                                        <select name="possui_filhos" id="possui_filhos" class="form-select active-floatlabel" >
                                            <option></option>
                                            <option value="Sim" {{ old('possui_filhos', $membro->possui_filhos ) == 'Sim' ? 'selected' : ''}}> Sim</option>
                                            <option value="Não" {{ old('possui_filhos', $membro->possui_filhos ) == 'Não' ? 'selected' : ''}}> Não</option>
                                        </select>
                             ...
                             <div class="col-4 form-campo" id="filhosSimContainer" >
                                <div class="mb-3">
                                    <div class="floatlabel-wrapper">
                                         <input type="number" class="floatlabel form-control" id="filhos_qtd" name="filhos_qtd"  placeholder="Quantidade dos filhos?" value="{{ old('filhos_qtd', $membro->filhos_qtd)}}" disabled>
                            ...
                            <div class="col-4 form-campo" id="filhosSimContainer" >
                                <div class="mb-3">
                                    <div class="floatlabel-wrapper">
                                         <input type="text" class="floatlabel form-control" id="filhos_idade" name="filhos_idade"  placeholder="Qual a idade dos filhos?" value="{{ old('filhos_idade', $membro->filhos_idade)}}" disabled>
                                ...
                                <div class="mb-3">
                                    <div class="floatlabel-wrapper ">
                                        ...
                                        <select name="sexo" id="sexo" class="form-select active-floatlabel" >
                                            <option></option>
                                            <option value="Mulher" {{ old('sexo', $membro->sexo ) == 'Mulher' ? 'selected' : ''}}> Feminino</option>                                            
                                            <option value="Homem" {{ old('sexo', $membro->sexo ) == 'Homem' ? 'selected' : ''}}> Masculino</option>                                            
                                        </select>
                            ...
                            <div class="col-4 form-campo">
                                <div class="mb-3 position-relative">
                                    ...
                                    <input type="text" placeholder="CEP" class="floatlabel form-control" id="cep" name="cep" value="{{ old('cep', $membro->cep)}}" >
                            ...
                            <div class="col-8 form-campo">
                                <div class="mb-3">
                                    <input type="text" placeholder="Rua" class="floatlabel form-control" id="logradouro" name="logradouro" value="{{ old('logradouro', $membro->logradouro )}}" >
                            ...
                            <div class="col-3 form-campo">
                                <div class="mb-2">
                                    <input type="text" placeholder="Número" class="floatlabel form-control" id="numero" name="numero" value="{{ old('numero', $membro->numero)}}" >
                            ...
                            <div class="col-4 form-campo">
                                <div class="mb-2">
                                    <input type="text" placeholder="Complemento" class="floatlabel form-control" id="complemento" name="complemento" value="{{ old('complemento', $membro->complemento )}}" >
                            ...
                            <div class="col-5 form-campo">
                                <div class="mb-3">
                                    <input type="text" placeholder="Bairro" class="floatlabel form-control" id="bairro" name="bairro" value="{{ old('bairro', $membro->bairro )}}" >
                            ...
                            <div class="col-6 form-campo">
                                <div class="mb-3">
                                    <input type="text" placeholder="Cidade" class="floatlabel form-control" id="cidade" name="cidade" value="{{ old('cidade', $membro->cidade )}}" >
                            ...
                            <div class="col-6 mb-3 form-campo">
                                <div class="floatlabel-wrapper ">
                                    ...
                                    <select name="uf" id="uf" class="form-select active-floatlabel" >
                                        <option></option>
                                        @php
                                        echo get_estados(old('uf', $membro->uf ));
                                        @endphp
                                    </select>
                            ...
                            <div class="col-6 form-campo">
                                <div class="mb-3">
                                    <input type="email" placeholder="E-mail" class="floatlabel form-control" id="email" name="email" value="{{ old('email', $membro->email )}}" >
                            ...
                            <div class="col-6 form-campo">
                                <div class="mb-3">
                                    <input type="text" placeholder="Telefone Celular(Whatsapp)" class="floatlabel form-control" id="telefone_celular" value="{{ old('telefone_celular', $membro->telefone_celular)}}" name="telefone_celular" >
                            ...
                            <div class="col-6 form-campo">
                                <div class="mb-3">
                                    <input type="text" placeholder="Telefone para recado" class="floatlabel form-control" id="telefone_residencial" value="{{ old('telefone_residencial', $membro->telefone_residencial )}}" name="telefone_residencial" >
                            ...
                            <div class="col-6 form-campo">
                                <div class="mb-3">
                                    <input type="text" placeholder="Nome para recado" class="floatlabel form-control" id="nome_contato" value="{{ old('nome_contato', $membro->nome_contato )}}" name="nome_contato" >
                            ...
                            <div class="col-6 form-campo">
                                <div class="mb-3">
                                    <input type="text" placeholder="Instagram (opcional)" class="floatlabel form-control" id="instagram" value="{{ old('instagram', $membro->instagram)}}" name="instagram">
                           ...
                           <!-- Data de Conversão -->
                            <div class="col-6 form-campo">
                                <div class="mb-3">
                                    <div class="floatlabel-wrapper ">
                                        ...
                                        <input type="date" class="form-control active-floatlabel" id="data_conversao" name="data_conversao" value="{{ old('data_conversao', $membro->data_conversao)}}" >
                            ...
                            <div class="col-6 form-campo">
                                <div class="mb-3">
                                    <div class="floatlabel-wrapper ">
                                        ...
                                        <input type="date" class="form-control active-floatlabel" id="data_batismo" name="data_batismo" value="{{ old('data_batismo', $membro->data_batismo )}}" >
                            ...
                            <div class="col-6 form-campo">
                                <div class="mb-3">
                                    <div class="floatlabel-wrapper ">
                                        ...
                                        <input type="date" class="form-control active-floatlabel" id="data_membresia" name="data_membresia" value="{{ old('data_membresia', $membro->data_membresia)}}" >
                            ...
                            <div class="col-12 form-campo">
                                <div class="mb-3">
                                    <textarea id="observacao" name="observacao" class="form-control">{{ old('observacao', $membro->observacao)}}</textarea>
                        ...
                        <div class="col-9 bloco-submit d-flex mt-3">
                            ...
                            <a href="{{ route('membros.index')}}" class="btn-padrao btn-cancelar ms-3">Cancelar</a>
                        </div>
                    ...
                    <div class="col-3 border-start py-0 ps-5 form-r">
                            ...
                            <div class="mb-3 d-flex flex-column align-items-center">
                                ...
                                @php
                                    $fotoCandidato = $membro->foto_membro;
                                    $fotoCandidatoPath = $fotoCandidato ? asset("documents/membros/fotos/{$fotoCandidato}") : asset("img/image-not-found.png");
                                    //dd($fotoCandidatoPath);
                                @endphp

                                <input type="file" id="foto_membro" class="file-input" accept="image/*" name="foto_membro">
                                <div class="preview-container mb-3">
                                    <img id="preview_foto_membro" src="{{ $fotoCandidatoPath }}" class="preview_foto_membro" alt="Prévia Foto Membro">
                                </div>
